...
export enum GL_RENDERING_PRIMITIVES {
    LINES = GL_LINES,
...
export enum GL_CLEARING_BUFFERS {
...
export enum GL_BUFFERS_TARGET {
    ARRAY_BUFFER = GL_ARRAY_BUFFER,
    ELEMENT_ARRAY_BUFFER = GL_ELEMENT_ARRAY_BUFFER,
}

export enum GL_BUFFERS_USAGE {
    DYNAMIC_DRAW = GL_DYNAMIC_DRAW,
    STATIC_DRAW = GL_STATIC_DRAW,
    STREAM_DRAW = GL_STREAM_DRAW,
}

export enum GL_DATA_TYPES {
    BYTE = GL_DATA_BYTE,
    UNSIGNED_BYTE = GL_DATA_UNSIGNED_BYTE,
    SHORT = GL_DATA_SHORT,
    UNSIGNED_SHORT = GL_DATA_SHORT,
    INT = GL_DATA_INT,
    UNSIGNED_INT = GL_DATA_UNSIGNED_INT,
    FLOAT = GL_DATA_FLOAT,
}

export enum GL_SHADERS {
