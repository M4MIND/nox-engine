import { Camera, Canvas, CubePrimitive, CylinderPrimitive, Engine, GameObject, PlanaPrimitive, RigidBodyComponent, SceneManager, ScriptComponent, SuzannePrimitive, Vector3 } from "@gengine/engine";
...
class Main extends ScriptComponent {
    public start(sceneManager: SceneManager): void {
        for (var i = 0; i < 50; i++) {
            ...
            let plane = sceneManager.getActiveScene().addObject(PlanaPrimitive);

            plane.transform.scale = new Vector3(40,40,40)
        }
    }
